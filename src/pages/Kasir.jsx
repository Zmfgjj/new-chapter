  ...
  return (
    <MobileLayout activeMenu="Dashboard">
      ...
      <div className="hidden lg:flex justify-between items-center px-6 xl:px-10 py-5 bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b border-emerald-100/50 shadow-sm">
        <div>
          <h1 className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-[#14532d] to-[#b8860b] flex items-center gap-3">
            Overview Dashboard
            {isInvestor && (
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            ...
            <p className="text-xs" style={{ color: '#d4af37' }}>Kasir Aktif</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
            ...
            <div className="lg:hidden">
              <h1 className="text-xl font-black bg-clip-text text-transparent bg-gradient-to-r from-[#14532d] to-[#b8860b] flex items-center gap-2 flex-wrap">
                Overview Dashboard
                {isInvestor && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              ...
              {/* Card 1: Pendapatan */}
              <div className="rounded-3xl p-5 md:p-6 shadow-lg shadow-emerald-900/10 hover:-translate-y-1 transition-transform duration-300 bg-gradient-to-br from-[#14532d] to-[#d4af37] text-white relative overflow-hidden group">
                ...
                <div className="flex justify-between items-start relative z-10">
                  <div>
                    <p className="text-emerald-100 text-sm font-semibold mb-1">Total Pendapatan</p>
              ...
              <div className="rounded-3xl p-5 md:p-6 shadow-lg shadow-emerald-900/5 hover:-translate-y-1 transition-transform duration-300 bg-gradient-to-br from-emerald-400 to-emerald-500 text-white relative overflow-hidden group">
                ...
                <div className="flex justify-between items-start relative z-10">
                  <div>
                    <p className="text-emerald-50 text-sm font-semibold mb-1">Total Pesanan</p>
            ...
            {canView('pos') && (
              <div className="flex gap-4">
                <button 
                  ...
                  className="flex-1 bg-white border border-[#EDE0CC] hover:border-[#14532d] hover:shadow-md p-4 rounded-2xl flex items-center justify-between group transition-all"
                >
                  <div className="flex items-center gap-3 md:gap-4">
                    <div className="p-3 bg-emerald-50 text-[#14532d] rounded-xl group-hover:bg-[#14532d] group-hover:text-white transition-colors">
                      <ShoppingCart size={24} />
                    </div>
                    <div className="text-left">
                      <p className="font-bold text-[#14532d] text-base md:text-lg">Buka Kasir POS</p>
                      <p className="text-xs text-gray-500">Mulai terima pesanan baru</p>
                    </div>
                  </div>
                  <ArrowRight className="text-[#14532d] opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                </button>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="bg-white rounded-3xl p-5 md:p-7 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col h-80 md:h-96">
                <div className="flex justify-between items-center mb-4 md:mb-6">
                  <h2 className="font-bold text-lg md:text-xl flex items-center gap-2" style={{ color: '#14532d' }}>
                    <Clock size={22} className="text-emerald-500" /> Diproses
                  </h2>
                  <span className="bg-emerald-100 text-emerald-800 text-xs font-bold px-3 py-1 rounded-full">{pesananDiproses.length} Antrian</span>
                </div>
                ...
                <div className="flex-1 overflow-y-auto pr-2 space-y-3">
                  {pesananDiproses.length === 0 ? (
                    ...
                    pesananDiproses.map((p) => (
                      <div key={p.id} className="group flex items-center justify-between p-3 md:p-4 rounded-2xl border border-gray-100 hover:border-emerald-200 hover:shadow-md hover:bg-emerald-50/30 transition-all">
                        <div className="flex items-center gap-3 md:gap-4">
                          ...
                          <div>
                            ...
                            <div className="flex gap-2 mt-1 text-xs">
                              <span className={p.status === 'pending' ? 'text-emerald-600 font-medium' : 'text-blue-600 font-medium'}>
                        ...
                        <button
                          ...
                          className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white border border-gray-200 text-gray-500 flex items-center justify-center group-hover:bg-[#14532d] group-hover:text-white group-hover:border-[#14532d] transition-colors shadow-sm"
                        >
                          <ArrowRight size={18} />
                        </button>
                      </div>
                    ...
                    <tbody className="text-sm">
                      {pesanan.slice(0, 6).map((p) => (
                        <tr key={p.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors group cursor-pointer" onClick={() => openDetail(p)}>
                          <td className="py-3 md:py-3.5 font-bold text-[#14532d]">#{String(p.id).padStart(3, '0')}</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden relative z-10">
            ...
            <div className="px-5 md:px-6 py-4 md:py-5 flex justify-between items-center border-b border-gray-100 bg-gray-50/50">
              <div>
                <h3 className="font-bold text-lg md:text-xl text-[#14532d]">
                  Detail Order <span className="text-emerald-600">#{String(detailPesanan.id).padStart(3, '0')}</span>
                </h3>
            ...
            <div className="p-5 md:p-6">
              <div className="flex gap-2 mb-6 flex-wrap">
                <span className="bg-emerald-50 text-emerald-800 px-3 py-1 rounded-lg text-xs font-bold border border-emerald-100">
                ...
                <span className={`px-3 py-1 rounded-lg text-xs font-bold border ${detailPesanan.status === 'selesai' ? 'bg-emerald-50 text-emerald-700 border-emerald-100' : detailPesanan.status === 'diproses' ? 'bg-indigo-50 text-indigo-700 border-indigo-100' : 'bg-emerald-50 text-emerald-700 border-emerald-100'}`}>
                  ...
                  {(detailPesanan.items || []).length === 0 ? (
                    ...
                    detailPesanan.items.map((item, i) => (
                      <div key={i} className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-bold text-[#14532d]">{item.qty}x</p>
              ...
              <div className="space-y-2">
                ...
                <div className="border-t border-dashed border-gray-200 pt-3 mt-3 flex justify-between items-end">
                  ...
                  <span className="font-black text-xl md:text-2xl text-[#14532d]">Rp {Math.max(0, (detailPesanan.total || 0) - (detailPesanan.dp_amount || 0)).toLocaleString('id-ID')}</span>
                </div>
              </div>
            </div>
          </div>
