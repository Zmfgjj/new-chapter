    ...
    <div className="h-full bg-[#FFFAF1] flex flex-col overflow-hidden">
      <header className="bg-[#ECD7B1] h-[70px] flex items-center px-4 shadow-sm sticky top-0 z-30">
        <div className="flex-1 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full border-2 flex items-center justify-center bg-black overflow-hidden" style={{ borderColor: '#14532d' }}>
            <img src="/logo.jpeg" alt="Logo" className="w-full h-full object-cover" />
          </div>
          <div>
            <h1 className="text-lg font-bold text-[#442D1D] leading-tight">New Chapter</h1>
          </div>
        </div>
        <div className="flex items-center gap-4 text-[#14532d]">
          <a href="https://www.instagram.com/NewChapter?igsh=aGF6dnZsNDlhM2dl" target="_blank" rel="noopener noreferrer" className="hover:opacity-85 transition-opacity" title="Instagram">
          ...
          <a href="https://www.tiktok.com/@NewChapter" target="_blank" rel="noopener noreferrer" className="hover:opacity-85 transition-opacity" title="TikTok">
          ...
          <a href="https://youtube.com/@NewChapter?si=TSD54UWgSvZejUcH" target="_blank" rel="noopener noreferrer" className="hover:opacity-85 transition-opacity" title="YouTube">
            <svg className="w-6 h-6 hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Info Banner */}
      <div className="bg-[#FFF5E5] border-b border-[#ECD7B1] px-4 py-3 flex items-center gap-3 text-[#14532d] text-sm md:text-base font-semibold shadow-inner">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="bg-white border-b border-[#ECD7B1] px-4 py-3 flex flex-col md:flex-row gap-3">
            <div className="flex gap-3 overflow-x-auto scrollbar-hide flex-1">
              <button
                ...
                className={`px-5 py-2 rounded-full text-base font-semibold whitespace-nowrap transition ${activeKat === null
                    ...
                    : 'bg-[#FFF5E5] text-[#d4af37] hover:bg-[#ECD7B1]'
                  }`}
              >
                Semua
              </button>
            ...
            <div className="relative w-full md:w-64 shrink-0">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 border border-[#ECD7B1] rounded-full text-sm focus:outline-none focus:border-[#14532d] text-[#442D1D] bg-[#FFF5E5]"
              />
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            {loadingData ? (
              ...
              <div className="text-center text-[#d4af37] py-16">
                <div className="flex justify-center mb-3 text-[#d4af37]"><Utensils size={48} /></div>
                      ...
                      <div className="w-full aspect-square bg-[#F5F0E8] overflow-hidden relative">
                        ...
                        {menu.gambar ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center text-4xl">
                            <Utensils size={40} className="text-[#d4af37]" />
                          </div>
                        )}
                      </div>
                          ...
                          {menu.deskripsi && menu.deskripsi !== '-' && menu.deskripsi.trim() !== '' && (
                            ...
                            >
                              ...
                              {expandedDescId !== menu.id && menu.deskripsi.length > 40 && (
                                <p className="text-[9px] text-center text-[#d4af37] mt-0.5 font-bold hover:underline">Baca selengkapnya...</p>
                              )}
                            </div>
                          )}
                          {activePromo ? (
                        ...
                        <div>
                          {variants.length > 0 && (
                            <select
                              ...
                              className="w-full border border-gray-200 rounded-lg px-2 py-1.5 text-xs font-semibold text-[#442D1D] bg-gray-50 focus:outline-none focus:border-[#14532d]"
                            >
                              {variants.map(v => (
