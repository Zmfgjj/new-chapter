    ...
    <MobileLayout activeMenu="Manajemen Menu">
      ...
      <div className="hidden lg:flex justify-between items-center px-6 xl:px-10 py-5 bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b border-emerald-100/50 shadow-sm">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-emerald-50 text-[#14532d] flex items-center justify-center shadow-sm border border-emerald-100">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-medium mt-0.5">Atur menu yang ditawarkan oleh New Chapter</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <div className="text-right">
            <p className="text-sm font-bold" style={{ color: '#14532d' }}>Halo, {user?.username}</p>
            <p className="text-xs uppercase" style={{ color: '#d4af37' }}>{user?.role || 'Kasir'}</p>
          </div>
      ...
      <div className="flex-1 overflow-auto p-4 md:p-6 xl:p-10 scroll-smooth">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
            <div className="relative group w-full sm:w-80">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-stone-400 group-focus-within:text-[#14532d] transition-colors">
                <Search size={18} />
              </div>
              <input
                type="text"
                ...
                className="w-full pl-11 pr-4 py-3 bg-white border border-stone-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#14532d]/20 focus:border-[#14532d] transition-all shadow-sm text-sm"
              />
            </div>
            ...
            {canEdit && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 rounded-2xl font-medium text-emerald-50 bg-[#166534] hover:bg-[#14532d] transition-all duration-300 shadow-lg shadow-[#166534]/20 hover:shadow-[#166534]/30 hover:-translate-y-0.5 active:scale-95"
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 rounded-2xl font-medium text-emerald-50 bg-[#d4af37] hover:bg-[#166534] transition-all duration-300 shadow-lg shadow-[#d4af37]/20 hover:shadow-[#d4af37]/30 hover:-translate-y-0.5 active:scale-95"
                >
                  Kelola Kategori
                </button>
                <button
                  onClick={() => setShowTambah(true)}
                  className="flex items-center gap-2 px-6 py-3 rounded-2xl font-medium text-emerald-50 bg-[#14532d] hover:bg-[#052e16] transition-all duration-300 shadow-lg shadow-[#14532d]/20 hover:shadow-[#14532d]/30 hover:-translate-y-0.5 active:scale-95"
                >
                  Tambah Menu Baru
                </button>
              </div>
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-32 space-y-4">
              <div className="w-12 h-12 border-4 border-[#14532d]/20 border-t-[#14532d] rounded-full animate-spin"></div>
                ...
                <div key={menu.id} className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-stone-100 overflow-hidden flex flex-col hover:-translate-y-1">
                  ...
                  <div className="relative aspect-video w-full bg-stone-100 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 z-10">
                      <span className="px-3 py-1.5 rounded-full text-xs font-bold tracking-wide shadow-sm backdrop-blur-md bg-white/90 text-[#14532d] border border-white/20">
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="font-bold text-base text-stone-800 leading-snug mb-1 group-hover:text-[#14532d] transition-colors">{menu.nama}</h3>
                    ...
                    <div className="mt-3 pt-3 border-t border-stone-100 flex items-end justify-between">
                      <div>
                        ...
                        {Number(menu.harga_diskon) > 0 ? (
                          ...
                          <p className="font-extrabold text-lg text-[#14532d]">
                      ...
                      {canEdit && (
                        <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-1 group-hover:translate-y-0">
                          <button
                            ...
                            className="p-2.5 rounded-xl bg-stone-50 text-stone-600 hover:bg-[#14532d]/10 hover:text-[#14532d] transition-colors"
                            title="Edit Menu"
                          >
                            <Edit2 size={16} />
                          </button>
        ...
        <div className="fixed inset-0 bg-stone-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-all duration-300">
          <div className="bg-white rounded-3xl p-8 max-w-lg w-full max-h-[90vh] overflow-auto shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="w-10 h-10 rounded-full bg-[#14532d]/10 flex items-center justify-center text-[#14532d]">
                <Plus size={20} />
              </div>
            </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#14532d]/20 focus:border-[#14532d] transition-all text-sm"
                />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#14532d]/20 focus:border-[#14532d] transition-all text-sm"
                    />
                  </div>
                </div>
                <div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#14532d]/20 focus:border-[#14532d] transition-all text-sm appearance-none"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#14532d]/20 focus:border-[#14532d] transition-all text-sm resize-none"
                />
              </div>
              ...
              <div className="border border-stone-200 rounded-xl p-4 bg-stone-50">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button type="button" onClick={() => setFormTambah(prev => ({ ...prev, variants: [...prev.variants, { nama: '', harga_tambahan: 0 }] }))} className="text-xs bg-[#14532d] text-white px-2 py-1 rounded hover:bg-[#052e16] transition-colors flex items-center gap-1"><Plus size={14} /> Tambah Varian</button>
                </div>
                  ...
                  <div className="space-y-3">
                    {formTambah.variants.map((v, i) => (
                      <div key={i} className="flex items-center gap-2">
                        ...
                        }} className="flex-1 px-3 py-2 border border-stone-300 rounded focus:outline-none focus:border-[#14532d] text-sm" />
                        ...
                        }} className="w-32 px-3 py-2 border border-stone-300 rounded focus:outline-none focus:border-[#14532d] text-sm" />
                ...
                <div className="relative border-2 border-dashed border-stone-200 rounded-xl bg-stone-50 p-4 text-center hover:bg-stone-100 transition-colors group">
                  ...
                  {formTambah.gambarPreview ? (
                    ...
                    <div className="py-6 flex flex-col items-center text-stone-500">
                      <ImageIcon size={32} className="mb-2 text-stone-400 group-hover:text-[#14532d] transition-colors" />
                      <span className="text-sm font-medium text-[#14532d]">Klik untuk upload</span>
            ...
            <div className="flex gap-3 mt-8 pt-6 border-t border-stone-100">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl font-semibold text-emerald-50 bg-[#14532d] hover:bg-[#052e16] transition-all duration-200 disabled:opacity-50 shadow-md shadow-[#14532d]/20 active:scale-95"
              >
          ...
          <div className="bg-white rounded-3xl p-8 max-w-lg w-full max-h-[90vh] overflow-auto shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="space-y-5">
              ...
              <div className="border border-stone-200 rounded-xl p-4 bg-stone-50">
                <div className="flex items-center justify-between mb-3">
                  <label className="block text-sm font-bold text-stone-700">Variasi Menu & Harga (Opsional)</label>
                  <button type="button" onClick={() => setFormEdit(prev => ({ ...prev, variants: [...prev.variants, { nama: '', harga_tambahan: 0 }] }))} className="text-xs bg-[#14532d] text-white px-2 py-1 rounded hover:bg-[#052e16] transition-colors flex items-center gap-1"><Plus size={14} /> Tambah Varian</button>
                </div>
              ...
              <div className="flex items-center gap-3 p-4 bg-stone-50 border border-stone-200 rounded-xl">
                <div className="relative flex items-center">
                  <input
                    ...
                    className="peer w-5 h-5 rounded-md border-stone-300 text-[#14532d] focus:ring-[#14532d] accent-[#14532d] cursor-pointer"
                  />
                </div>
                <div className="flex flex-col">
              ...
              <div>
                ...
                <div className="relative border-2 border-dashed border-stone-200 rounded-xl bg-stone-50 p-4 text-center hover:bg-stone-100 transition-colors group">
                  ...
                  {formEdit.gambarPreview ? (
                    ...
                    <div className="py-6 flex flex-col items-center text-stone-500">
                      <ImageIcon size={32} className="mb-2 text-stone-400 group-hover:text-[#14532d] transition-colors" />
                      <span className="text-sm font-medium text-[#14532d]">Upload gambar baru</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl">
            <div className="px-8 py-6 border-b border-stone-100 flex justify-between items-center bg-stone-50/50 rounded-t-3xl">
              <h2 className="text-2xl font-black text-[#14532d]">Kelola Kategori</h2>
            ...
            <div className="p-8 overflow-y-auto flex-1 bg-stone-50/30">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 mb-8">
                ...
                <div className="flex gap-2">
                  <button onClick={handleSimpanKategori} disabled={loadingKategori} className="px-6 py-2 bg-[#14532d] text-white rounded-xl font-bold hover:bg-[#052e16] transition-colors">{loadingKategori ? 'Menyimpan...' : 'Simpan'}</button>
                    ...
                    {kategoriList.map(kat => (
                      <tr key={kat.id} className="hover:bg-stone-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <span className={`px-3 py-1 rounded-full text-xs font-bold ${kat.print_destination === 'bar' ? 'bg-blue-100 text-blue-700' : kat.print_destination === 'semua' ? 'bg-purple-100 text-purple-700' : kat.print_destination === 'tidak_cetak' ? 'bg-stone-200 text-stone-600' : 'bg-emerald-100 text-emerald-700'}`}>
