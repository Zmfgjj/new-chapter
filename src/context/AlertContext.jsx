            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="min-w-0 flex-1">
                <h3 className={`font-black text-lg truncate ${
                  ...
                  'bg-clip-text text-transparent bg-gradient-to-r from-[#14532d] to-[#b8860b]'
                }`}>
                  {alertState.title}
                </h3>
              </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl transform transition-all scale-100 p-5 md:p-6" style={{ border: '1px solid #EDE0CC' }}>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <button 
                ...
                className="flex-1 py-2.5 rounded-xl text-white text-sm font-black transition-all hover:opacity-90 active:scale-95 shadow-lg flex items-center justify-center gap-1.5 bg-[#14532d]"
              >
