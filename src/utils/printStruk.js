  ...
  return `
    <div style="width:280px;font-family:'Courier New',monospace;padding:8px;margin:0 auto">
      <div style="text-align:center;margin-bottom:8px">
        <h3 style="margin:0;font-size:16px;font-weight:normal;">New Chapter</h3>
        <p style="margin:2px 0;font-size:12px">Jl. Raya Bojonggede - Kemang</p>
        <p style="margin:2px 0;font-size:12px">NewChapter</p>
      ...
      <div style="font-size:12px;display:flex;justify-content:space-between;">
        ...
        <div style="text-align:right">
          ...
          <p style="margin:2px 0">Kasir : New Chapter</p>
      ...
      <div style="font-size:12px">
        ...
        ${(point_earned > 0) ? `<div style="display:flex;justify-content:space-between;margin:2px 0;color:#d4af37;font-weight:bold;margin-top:4px;"><span>Poin Didapat</span><span>+${point_earned} Poin</span></div>` : ''}
      </div>
      <hr style="border:none;border-top:1px dashed #000;margin:8px 0">
      ...
      <div style="text-align:center;font-size:12px;margin-top:8px">
        ...
        <div style="display:inline-block; text-align:left;">
          ...
          <p style="margin:2px 0">&nbsp;&nbsp;&nbsp;Pass: New Chapternaikkelaz</p>
          <p style="margin:2px 0">2. User: NewChapter_5G</p>
        ...
        <p style="margin:2px 0;font-weight:bold;margin-bottom:8px;">s.id/NewChapter-maps</p>
        <p style="margin:2px 0">Instagram: @NewChapter</p>
        <p style="margin:2px 0">TikTok: @NewChapter</p>
        <p style="margin:2px 0">YouTube: @NewChapter</p>
      </div>
    </div>
  `
}
  ...
  try {
    ...
    for (const type of printTypes) {
      ...
      if (isDapurOrBar) {
        ...
        receipt += CENTER + DOUBLE
        receipt += 'New Chapter' + LF
        receipt += NORMAL
        receipt += 'Jl. Raya Bojonggede - Kemang' + LF
        receipt += 'NewChapter' + LF
        ...
        const kasirT1 = padLeft('Kasir : New Chapter', 16);
        ...
        receipt += LEFT + '       Pass: New Chapternaikkelaz' + LF
        receipt += LEFT + '    2. User: NewChapter_5G' + LF
        ...
        receipt += 'follow kami @NewChapter' + LF
